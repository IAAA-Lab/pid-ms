...
public class WFSClient {
    ...
    static String createWfsGetFeatureRequestBodyPost(Source source, BoundingBox boundingBox, String type) {
        return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                ...
                + "<wfs:Query typeNames=\"" + source.getQualifiedFeatureType() + "\">"
                + "<fes:Filter><fes:Intersects><fes:ValueReference>" + source.getQualifiedGeometryProperty() + "</fes:ValueReference>"
    ...
    static String createWfsGetFeatureRequestGet(Source source, BoundingBox boundingBox, String type){
    	return source.getEndpointLocation() + "?request=GetFeature&service=WFS&typeNames=" + source.getFeatureType()
    			+"&resultType=" + type +"&version=2.0.0&srsName=" + source.getSrsName() +"&BBOX="
    			+ boundingBox.getMinX() +","+ boundingBox.getMinY() + "," + boundingBox.getMaxX() + ","
    			+ boundingBox.getMaxY() + "&startIndex=0&count=" + source.getFeaturesThreshold();
    }
