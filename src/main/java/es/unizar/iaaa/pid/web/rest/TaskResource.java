...
public class TaskResource {
    ...
    public ResponseEntity<List<TaskDTO>> getAllTasks(@ApiParam Pageable pageable) {
        ...
        if (SecurityUtils.isAuthenticated()) {
        	page = taskService.findAllInPrincipalOrganizations(pageable);
        }  
        else {
        	page = taskService.findAllPublic(pageable);
        }
    ...
    public ResponseEntity<TaskDTO> getTask(@PathVariable Long id) {
        ...
        if (SecurityUtils.isAuthenticated()) {
        	taskDTO = taskService.findOneInPrincipalOrganizations(id);
        }  
        else {
        	taskDTO = taskService.findOnePublic(id);
        }
